...
echo "   Fenster 'Assign predefined muxes to networks' : 'Network 1': Network DVB-T;  Pre-defined muxes : Germany: de-generic-all-channels"
echo "   Fenster 'Assign predefined muxes to networks' : 'Network 1': Network DVB-T;  URL : file:///storage/downloads/oerlie_installation/kn-pipe-tv-adapted-sorted"
echo "   --> Als Ergebnis erscheint z.B. 'Found muxes 264'; 'Found services 145'"
echo "   Fenster 'Service mapping' : Map all services; Create provider tags; Create network tags"
echo "   Configuration > DVB Inputs > Networks > Edit Network > Channel numbers from 1 > Save"
